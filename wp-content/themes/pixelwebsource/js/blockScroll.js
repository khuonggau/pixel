  ...
  $.fn.blockScroll = function(options) {
    ...
    function bindEvents()
    {
      $(window).on('scroll', function(e) {
        ...
        $('.bullet-wrapper ul li:nth-child('+(indexOfClosest+1)+') span').css({'display':'block'});
        if(indexOfClosest == 1){
          $('.pixel-01 .flipX').css({'animation':'tada-it 2s ease','-webkit-animation':'tada-it 2s ease','-webkit-animation-fill-mode':'both','animation-fill-mode':'both'})
        }
        if(indexOfClosest == 2){
          $('.pixel-02 .bounce').css({'animation':'rotate 14s linear','-webkit-animation':'rotate 14s linear ','-webkit-animation-fill-mode':'both','animation-fill-mode':'both'})
        }
        /*if(indexOfClosest == 3){
          $('.pixel-03 #tada').css({'animation':'tada-it 1s ease','-webkit-animation':'tada-it 1s ease','-webkit-animation-fill-mode':'both','animation-fill-mode':'both'})
        }*/
        if(indexOfClosest == 3){
          $('.pixel-03 .circle').css({'animation':'rollIn-it 5s ease','-webkit-animation':'rollIn-it 5s ease'})
        }
        if(indexOfClosest != 0){
