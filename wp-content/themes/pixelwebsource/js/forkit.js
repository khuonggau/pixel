...
(function(){
	...
	function initialize() {
		...
		dom.curtain = document.querySelector( '#request_form' );
		dom.closeButton = document.querySelector( '#request_form .close-button' );
	...
	function render() {
		...
		if( dom.curtain && $(window).width() > 1024) {
